        ...
        @echo # ------------------------------------------------------------------------
        %sys.ColorNormal%
        @echo # resetting security on target resource(s)
        @echo.
        ...
        if /i %VALUE_RESTYPE:~0,1% NEQ %VALUE_RESTYPE_SYSPRIV% (
          if /i %VALUE_RESPARENT% NEQ %VALUE_RESPARENT_NONE% (
            ...
            if /i %target.TypeIsFs% EQU %STATUS_OK% (
              if /i %VALUE_RESPARENT:~0,2% EQU %VALUE_RESPARENT_ISDRIVE% (
                ...
                %fs.BinDir%\setacl -on "%VALUE_RESPARENT%\%VALUE_RESLABEL%" -ot file -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"
                ...
                for /d /r . %%i in (*"%VALUE_RESLABEL%") do (
                  ...
                  %fs.BinDir%\setacl -on "%%~i" -ot file -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"
            ...
            if /i %VALUE_RESTYPE% EQU %VALUE_RESTYPE_REG% (
              ...
              %fs.BinDir%\setacl -on "%VALUE_RESPARENT%\%VALUE_RESLABEL%" -ot reg -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"
            ...
            if /i %VALUE_RESTYPE% EQU %VALUE_RESTYPE_PRN% (
              ...
              %fs.BinDir%\setacl -on "%VALUE_RESLABEL%" -ot prn -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"
            ...
            if /i %VALUE_RESTYPE% EQU %VALUE_RESTYPE_SCM% (
              ...
              %fs.BinDir%\setacl -on "%VALUE_RESLABEL%" -ot srv -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"
          ...
          if /i %VALUE_RESTYPE% EQU %VALUE_RESTYPE_SVC% (
            ...
            if %service.IsRegistered% EQU %STATUS_OFF% (
              ...
              %fs.BinDir%\setacl -on "%fs.ServicesRootDir%\%VALUE_RESLABEL%" -ot file -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"               >  nul
              ...
              %fs.BinDir%\setacl -on "%fs.CurrentBackupRootDir%\%service.CurrentResLabel%" -ot file -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"  >  nul
              ...
              %fs.BinDir%\setacl -on "%fs.ServicesRootDir%\%service.CurrentResLabel%" -ot file -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"       >  nul
            ...
            %fs.BinDir%\setacl -on "%VALUE_RESPARENT%\%VALUE_RESLABEL%" -ot file -ot file -actn clear -clr "dacl,sacl" -actn setprot -op "dacl:np;sacl:np" -rec cont_obj -actn rstchldrn -rst "dacl,sacl"             >  nul
