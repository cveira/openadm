if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  :: %fs.BinDir%\setacl -on "%systemroot%\system32\cmd.exe" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %ACL_LOCAL_AUDIT_SYSTEM% -ace "n:%COMPUTERNAME%\res-ts-syscmd-rx;p:read_ex" -ace "n:%COMPUTERNAME%\res-ts-syscmd-da;p:read_ex;m:deny" -actn clear -clr "dacl,sacl"
  ...
  :: @echo %fs.BinDir%\setacl -on "%systemroot%\system32\cmd.exe" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %ACL_LOCAL_AUDIT_SYSTEM% -ace "n:%COMPUTERNAME%\res-ts-syscmd-rx;p:read_ex" -ace "n:%COMPUTERNAME%\res-ts-syscmd-da;p:read_ex;m:deny" -actn clear -clr "dacl,sacl"
