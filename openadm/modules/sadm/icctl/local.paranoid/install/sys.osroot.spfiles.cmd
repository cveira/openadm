if exist "%systemroot%\servicepackfiles" (
  if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
    ...
    :: %fs.BinDir%\setacl -on "%systemroot%\servicepackfiles" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %ACL_LOCAL_AUDIT_SYSTEM% -actn clear -clr "dacl,sacl" -actn rstchldrn -rst "dacl,sacl"
    ...
    :: @echo %fs.BinDir%\setacl -on "%systemroot%\servicepackfiles" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %ACL_LOCAL_AUDIT_SYSTEM% -actn clear -clr "dacl,sacl" -actn rstchldrn -rst "dacl,sacl"
