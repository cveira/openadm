if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "e:\backup" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %ACL_LOCAL_AUDIT_SYSTEM% -ace "n:%COMPUTERNAME%\res-fs-backup;p:change" -ace "n:%COMPUTERNAME%\res-fs-backup-da;p:read_ex;m:deny" -ace "n:%COMPUTERNAME%\res-fs-backup-rx;p:read_ex" -ace "n:%COMPUTERNAME%\¡role-job-backup;p:change" -ace "n:%COMPUTERNAME%\role-job-replication;p:change" -actn clear -clr "dacl,sacl"
