...
if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "%systemroot%" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %sys.osroot.exclusions%
  ...
  @echo %fs.BinDir%\setacl -on "%systemroot%" -ot file -actn ace %ACL_LOCAL_SYSTEM_PROFILE% %sys.osroot.exclusions%
