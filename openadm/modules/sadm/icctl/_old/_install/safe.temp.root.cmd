...
if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "d:" -ot file -actn ace %ACL_SYSTEM_PROFILE% %temp.root.exclusions%
  ...
  @echo %fs.BinDir%\setacl -on "d:" -ot file -actn ace %ACL_SYSTEM_PROFILE% %temp.root.exclusions%
