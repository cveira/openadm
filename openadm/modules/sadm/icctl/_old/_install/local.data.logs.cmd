if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "e:\logs" -ot file -actn ace %ACL_SYSTEM_PROFILE% %ACL_AUDIT_SYSTEM% -ace "n:role-job-local;p:change" -ace "n:res-fs-logs;p:change" -ace "n:res-fs-logs-da;p:read_ex;m:deny" -ace "n:res-fs-logs-rx;p:read_ex" -actn clear -clr "dacl,sacl"
  ...
  @echo %fs.BinDir%\setacl -on "e:\logs" -ot file -actn ace %ACL_SYSTEM_PROFILE% %ACL_AUDIT_SYSTEM% -ace "n:role-job-local;p:change" -ace "n:res-fs-logs;p:change" -ace "n:res-fs-logs-da;p:read_ex;m:deny" -ace "n:res-fs-logs-rx;p:read_ex" -actn clear -clr "dacl,sacl"
