if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "e:\backup" -ot file -actn ace %ACL_SYSTEM_PROFILE% %ACL_AUDIT_SYSTEM% -ace "n:res-fs-backup;p:change" -ace "n:res-fs-backup-da;p:read_ex;m:deny" -ace "n:res-fs-backup-rx;p:read_ex" -ace "n:¡sys-job-backup;p:change" -ace "n:sys-job-replication;p:change" -actn clear -clr "dacl,sacl"
  ...
  @echo %fs.BinDir%\setacl -on "e:\backup" -ot file -actn ace %ACL_SYSTEM_PROFILE% %ACL_AUDIT_SYSTEM% -ace "n:res-fs-backup;p:change" -ace "n:res-fs-backup-da;p:read_ex;m:deny" -ace "n:res-fs-backup-rx;p:read_ex" -ace "n:¡sys-job-backup;p:change" -ace "n:sys-job-replication;p:change" -actn clear -clr "dacl,sacl"
