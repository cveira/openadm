if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "e:\archive" -ot file -actn ace %ACL_SYSTEM_PROFILE% %ACL_AUDIT_SYSTEM% -ace "n:res-fs-archive;p:change" -ace "n:res-fs-archive-da;p:read_ex;m:deny" -ace "n:res-fs-archive-rx;p:read_ex" -ace "n:sys-job-archive;p:change" -actn clear -clr "dacl,sacl"
  ...
  @echo %fs.BinDir%\setacl -on "e:\archive" -ot file -actn ace %ACL_SYSTEM_PROFILE% %ACL_AUDIT_SYSTEM% -ace "n:res-fs-archive;p:change" -ace "n:res-fs-archive-da;p:read_ex;m:deny" -ace "n:res-fs-archive-rx;p:read_ex" -ace "n:sys-job-archive;p:change" -actn clear -clr "dacl,sacl"
