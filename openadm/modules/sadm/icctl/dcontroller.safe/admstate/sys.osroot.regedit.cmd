if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\subinacl /file "%systemroot%\regedit.exe" /grant=system=f /grant=builtin\administrators=f
  ...
  @echo %fs.BinDir%\subinacl /file "%systemroot%\regedit.exe" /grant=system=f /grant=builtin\administrators=f
