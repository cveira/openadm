if /i %VALUE_OPMODE% NEQ %VALUE_OPMODE_TEST% (
  ...
  %fs.BinDir%\setacl -on "%systemroot%\microsoft.net\framework\v1.1.4322\temporary asp.net files" -ot file -actn ace %ACL_DOMAIN_SYSTEM_PROFILE%
  ...
  for /f "eol=# tokens=*" %%i in (%fs.ModulesDir%\icctl\%icctl.profile%\conf\sys.osroot.dotnet11.ini) do (
    if exist "%systemroot%\microsoft.net\framework\v1.1.4322\%%i" (
      ...
      :: %fs.BinDir%\setacl -on "%systemroot%\microsoft.net\framework\v1.1.4322\%%i" -ot file -actn ace %ACL_DOMAIN_SYSTEM_PROFILE% %ACL_DOMAIN_AUDIT_SYSTEM% -ace "n:%ds.domain%\res-ts-sysdotnet-rx;p:read_ex" -ace "n:%ds.domain%\res-ts-sysdotnet-da;p:read_ex;m:deny" -actn clear -clr "dacl,sacl"

      %fs.BinDir%\setacl -on "%systemroot%\microsoft.net\framework\v1.1.4322\%%i" -ot file -actn ace %ACL_DOMAIN_AUDIT_SYSTEM% -ace "n:%ds.domain%\res-ts-sysdotnet-rx;p:read_ex" -ace "n:%ds.domain%\res-ts-sysdotnet-da;p:read_ex;m:deny"
  ...
  @echo %fs.BinDir%\setacl -on "%systemroot%\microsoft.net\framework\v1.1.4322\temporary asp.net files" -ot file -actn ace %ACL_DOMAIN_SYSTEM_PROFILE%
  ...
  for /f "eol=# tokens=*" %%i in (%fs.ModulesDir%\install\sys.osroot.dotnet11.ini) do (
    if exist "%systemroot%\microsoft.net\framework\v1.1.4322\%%i" (
      ...
      :: @echo %fs.BinDir%\setacl -on "%systemroot%\microsoft.net\framework\v1.1.4322\%%i" -ot file -actn ace %ACL_DOMAIN_SYSTEM_PROFILE% %ACL_DOMAIN_AUDIT_SYSTEM% -ace "n:%ds.domain%\res-ts-sysdotnet-rx;p:read_ex" -ace "n:%ds.domain%\res-ts-sysdotnet-da;p:read_ex;m:deny" -actn clear -clr "dacl,sacl"

      @echo %fs.BinDir%\setacl -on "%systemroot%\microsoft.net\framework\v1.1.4322\%%i" -ot file -actn ace %ACL_DOMAIN_AUDIT_SYSTEM% -ace "n:%ds.domain%\res-ts-sysdotnet-rx;p:read_ex" -ace "n:%ds.domain%\res-ts-sysdotnet-da;p:read_ex;m:deny"
