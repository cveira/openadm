        ...
        @echo # ------------------------------------------------------------------------
        %sys.ColorNormal%
        @echo # creating target resources [%VALUE_RESTYPE%-%input.LabelName%]
        @echo.
        ...
        if /i %VALUE_RESTYPE:~0,1% NEQ %VALUE_RESTYPE_SYSPRIV% (
          if /i %VALUE_RESPARENT% NEQ %VALUE_RESPARENT_NONE% (
            if /i %VALUE_RESPARENT:~1,1% EQU %VALUE_RESPARENT_ISDRIVE% (
              ...
              md      "%VALUE_RESPARENT%\%VALUE_RESLABEL%"  >  nul
          ...
          if /i %VALUE_RESTYPE% EQU %VALUE_RESTYPE_SVC% (
            setlocal enabledelayedexpansion
              ...
              if !service.IsRegistered! EQU %STATUS_OFF% (
                ...
                md      "%fs.ServicesRootDir%\%VALUE_RESLABEL%"  >  nul
                ...
                md      "!fs.CurrentBackupRootDir!\%service.CurrentResLabel%"   >  nul
                ...
                md      "%fs.ServicesRootDir%\%service.CurrentResLabel%"  >  nul
